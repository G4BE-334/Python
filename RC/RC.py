...
class Cube:
    ...
    # Attributes
    default_plastic_color = 'w'
    default_face_colors = ["gray", "#cfff04",
                           "#13eac9", "#0cff0c",
                           "#bc13fe", "#f7022a",
                           "gray", "gray"]
    ...
    # Defining rotation angles and axes for the six sides of the cube
    x, y, z = np.eye(3)
    ...
    def _initialize_arrays(self):
        ...
        # Start with a base for each one, and then translate & rotate them into position.
        ...
        for i in range(6):
            ...
            # Add face ID to the face centroids for lex-sorting
    ...
    def _sort_faces(self):
        # Use the lexsort on the centroids to put faces in the standard order.
...
class InteractiveCube(plt.Axes):
    ...
    def _draw_cube(self):
        ...
        if self._face_polys is None:
            # Initial call: creation of polygon and axes
            self._face_polys = []
            self._sticker_polys = []
